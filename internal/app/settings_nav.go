...
var settingsNodeCatalog = []settingsNavNode{
	...
	{ID: settingsNavStatusBar + ".agent-usage-hud.provider.model", Parent: settingsNavStatusBar + ".agent-usage-hud.provider", Label: "Model", LabelKey: "settings.text.model", Kind: settingsNavToggle, Axis: settingsAxisGlobal, Dynamic: true, Note: "runtime model name; Claude only"},
